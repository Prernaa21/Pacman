...
public class Board extends JPanel implements ActionListener{
    ...
    private Dimension d;
    private final Font smallFont = new Font("Merriweather", Font.BOLD, 14);
    private Image ii;
    private final Color dotColor = new Color(192, 0, 0);
...
private void showIntro(Graphics2D g2d){
    g2d.setColor(new Color(180,	167, 214));
    g2d.fillRect(50, SCREEN_SIZE/2 -30, SCREEN_SIZE - 100, 50);
    g2d.setColor(Color.white);
    g2d.drawRect(50, SCREEN_SIZE/2 -30, SCREEN_SIZE - 100, 50);

    String s = "Press s to Start";
    Font small = new Font("Merriweather", Font.BOLD, 14);
       ...
       for(i = 0; i < N_GHOSTS; i++) {
           if(ghosts_x[i] % BLOCK_SIZE == 0 & ghosts_y[i] % BLOCK_SIZE == 0 ) {
            ...
            ghosts_y[i] = ghosts_y[i] + (ghosts_dy[i]*ghostSpeed[i]);
              drawGhosts(g2d, ghosts_x[i] +1, ghosts_y[i] +1);
...
private void drawPacmanRight(Graphics2D g2d) {
   ...
   private void loadImages(){
       ghosts = new ImageIcon(this.getClass().getResource("/images/ghosts.jpg")).getImage();
